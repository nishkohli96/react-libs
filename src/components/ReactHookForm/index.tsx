        ...
        <Grid container item xs={12} style={{ margin: '20px 0px' }}>
          ...
          <Grid item xs={4}>
            <Controller
              ...
              render={({ field }) => (
                <Select {...field} label="Color" style={{ width: 120 }}>
          ...
          <Grid container item xs={12} key={field.id}>
            ...
            <Grid container item xs={2} alignItems="flex-end">
              <Controller
                ...
                defaultValue={initialFormValues.items?.[index]?.shape}
                render={({ field }) => (
                  <Select {...field} label="Shape" native>
                    {Object.values(ItemShape).map((shape, index2) => (
                      <option key={index2} value={shape}>
                        {shape}
                      </option>
                    ))}
                  </Select>
